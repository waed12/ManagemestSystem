		...
		if (result > 0) {
			...
			if (result > 0) {
				...
				try {
					...
					PrepareDeveloper = (PreparedStatement) con
							.prepareStatement("insert into developer(user_id,leader_id) values(?,?)");
					...
					PreparedStatement PrepareTask = (PreparedStatement) con
